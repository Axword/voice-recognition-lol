...
class LoLVoiceGUI:
    ...
    def create_widgets(self):
        ...
        title = tk.Label(main_frame, 
                        text="LoL Voice  Controller v0.2",
    ...
    def create_status_section(self, parent):
        ...
        self.status_vars = {
            ...
            'model': tk.StringVar(value="🎤 Model: Google"),
    ...
    def create_config_section(self, parent):
        ...
        # Model selection
        model_frame = tk.Frame(config_container, bg='#2b2b2b')
        model_frame.pack(side='left', padx=(0, 40))
        ...
        summ2_combo = ttk.Combobox(summ2_frame,
                                  ...
                                  width=5,
                                  font=('Segoe UI', 9))
        summ2_combo.pack(side='right', padx=(10, 0))
    ...
    def create_log_section(self, parent):
        ...
        self.log_message("🎯 LoL Voice  Controller v0.2 initialized")
    ...
    def load_initial_state(self):
        try:
            ...
            self.controller = LoLVoiceControllerV2(language)
            ...
            self.log_message(f"❌ Error initializing controller: {e}")
            messagebox.showerror("Error", f"Failed to initialize voice controller: {e}")
    ...
    def toggle_voice_control(self):
        ...
        try:
            ...
            self.log_message(f"❌ Error toggling voice control: {e}")
    ...
    def test_microphone(self):
        ...
        try:
            ...
            self.log_message(f"❌ Microphone test failed: {e}")
    ...
    def update_champion(self):
        ...
        try:
            ...
            self.log_message(f"❌ Champion update failed: {e}")
    ...
    def update_champion_display(self):
        ...
        try:
            ...
            self.log_message(f"❌ Error updating champion display: {e}")
    ...
    def on_language_change(self, event=None):
        ...
        try:
            self.controller = LoLVoiceControllerV2(self.language_var.get())
            keybinds = {
                'Flash': self.config.get('flash_key', 'f'),
                'Summoner2': self.config.get('summoner2_key', 'd')
            }
            ...
            self.log_message(f"❌ Error reinitializing controller: {e}")
